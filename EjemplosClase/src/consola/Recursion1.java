...
/*Definir la funci�n fun:Int ->Int tal que fun(1) = 1 
 ...
 */
	...
	/*Escribir un m�todo que dado una palabra y un n�mero n, imprima 
	...
	/*Definir por recursi�n la funci�n sumaCuadrados:Int -> Int
	 *  tal que (sumaCuadrados n) es la suma de los cuadrados 
	 *  de los n�meros de 1 a n.
	...
	/*Definir la funci�n potencia:Int->Int-> Int
